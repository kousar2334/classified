                                ...
                                <div class="row g-4">
                                        ...
                                        <div class="card mb-30">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-20">
                                                    <label for="title">{{ __tr('Item Name') }} <span
                                                ...
                                                <!-- Category -->
                                                <div class="form-group mb-20">
                                                    <label for="category">{{ __tr('Category') }} <span
                                                            class="text-danger">*</span></label>
                                                ...
                                                <div class="form-group mb-20" id="subcategory-wrapper"
                                                    ...
                                                    <label for="subcategory">{{ __tr('Subcategory') }} <span
                                                            class="text-danger">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="description">{{ __tr('Description') }} <span
                                                            class="text-danger">*</span>
                                                        <span
                                                            class="text-danger">({{ __tr('minimum 150 characters.') }})</span>
                                                    </label>
                                                    <textarea name="description" id="description" rows="6"
                                                        class="input-style w-100 textarea--form summernote @error('description') is-invalid @enderror"
                                                        placeholder="{{ __tr('Enter a Description') }}">{{ old('description', $ad->description) }}</textarea>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="right-sidebar">
                                            ...
                                            <div class="card mb-30">
                                                <div class="card-header">
                                                    <h6 class="card-title">{{ __tr('Contact') }}</h6>
                                                </div>
                                                <div class="card-body">
                                                    <div class="form-group mb-20">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="hide-number">
                                                            ...
                                                            <span class="black-font">
                                                                {{ __tr('Hide My Phone Number') }}</span>
                                                        </label>
                                                        <div class="mt-3">
                                                            <input
                                                                ...
                                                                id="phone" placeholder="{{ __tr('Type Phone') }}">
                                                            <div
                                            ...
                                            <div class="card mb-30">
                                                <div class="card-header">
                                                    <h6 class="card-title">{{ __tr('Media Uploads') }}</h6>
                                                </div>
                                                <div class="card-body">
                                                    <!-- Thumbnail Image -->
                                                    <div class="form-group mb-20">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if ($galleryImageLimit > 0)
                                                            ...
                                                            <small
                                                                class="text-muted d-block mt-2">{{ __tr('Click a box to add or replace a photo') }}
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="w-100 input-style" name="address" id="address" rows="3"
                                                        placeholder="{{ __tr('Enter your detailed address') }}">{{ old('address', $ad->address) }}</textarea>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                        </div>
